...
依赖维护允许在受限范围内重新生成已审查的发布产物，并使用稳定的 CI 角色名称进行验证。开发依赖更新未改变发布产物时，无需创建新版本。请参阅[贡献指南](https://github.com/hokupod/utsuri/blob/main/CONTRIBUTING.md#bounded-renovate-repair)。
