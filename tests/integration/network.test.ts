...
import { captureConfig, freePort, startFixtureServer, stopFixtureServer } from "./capture-helpers";
...
describe("network", () => {
  test("blocks external origins and mutation methods while preserving evidence", async () => {
