...
The current release has passed publication and isolated Git Plugin installation checks on both supported hosts; see the evidence in the [release guide](https://github.com/hokupod/utsuri/blob/main/docs/release.md).
...
Dependency maintenance supports bounded regeneration of reviewed release artifacts and stable CI role checks. Development-only updates with unchanged release artifacts do not require a new release. See [Contributing](https://github.com/hokupod/utsuri/blob/main/CONTRIBUTING.md#bounded-renovate-repair).
